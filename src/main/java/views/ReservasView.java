...
public class ReservasView extends JFrame {
     ...
     * Create the frame.
     */
    public ReservasView() throws IOException {
        super("Reserva");
        ...
        txtFechaEntrada.getCalendarButton().setFont(new Font("Roboto", Font.PLAIN, 8));
        txtFechaEntrada.setBounds(68, 161, 289, 35);
        txtFechaEntrada.getCalendarButton().setBounds(268, 0, 16, 33);
        ...
        txtFechaSalida.getCalendarButton().setFont(new Font("Roboto", Font.PLAIN, 8));
        txtFechaSalida.setBounds(68, 246, 289, 35);
        txtFechaSalida.getCalendarButton().setBounds(267, 1, 16, 31);
