...
public class MenuUsuario extends JFrame {
	 ...
	 */
	public MenuUsuario() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuUsuario.class.getResource("/imagenes/aH-150px.png")));
		...
		btnRegistro.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				ReservasView reservasView = null;
				try {
	    ...
	    labelFecha.setFont(new Font("Roboto", Font.PLAIN, 28));
	    ...
	    labelDescripcion.setFont(new Font("Roboto", Font.PLAIN, 14));
	    ...
	    labelDescripcion_1.setFont(new Font("Roboto", Font.PLAIN, 14));
